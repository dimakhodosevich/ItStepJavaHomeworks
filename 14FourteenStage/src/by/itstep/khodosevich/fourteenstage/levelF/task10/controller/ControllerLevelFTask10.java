package by.itstep.khodosevich.fourteenstage.levelF.task10.controller;

import by.itstep.khodosevich.fourteenstage.levelF.module.Array;
import by.itstep.khodosevich.fourteenstage.levelF.module.MergeSort;
import by.itstep.khodosevich.fourteenstage.levelF.module.OddNumber;
import by.itstep.khodosevich.fourteenstage.view.Printer;

import java.util.Arrays;
import java.util.Scanner;

public class ControllerLevelFTask10 {
    public static void main(String[] args) {
        try {
            ...
            Printer.print("\n1. Sort array by merge sort method (ascend) to the first odd element;");
            Printer.print("\n2. Sort array by merge sort method (ascend) to the last odd element.");
            ...
            if (variant == 1) {
                ...
                if (firstIndex == -1) {
                    ...
                    MergeSort.mergeSortAsc(array, 0, firstIndex - 1);
                ...
                if (lastIndex == -1) {
                    ...
                    MergeSort.mergeSortAsc(array, 0, lastIndex - 1);
                    Printer.print("\n" + Arrays.toString(array));
                }
            }
