...
public class ControllerMostParity {
    public static void main(String[] args) {
        ...
        String msg = String.format("Among your nubmers %d, %d, %d - are there most parity? "+
                "\nAnswer: %b.", var1, var2, var3, checkMostParityNumber(var1, var2, var3));
