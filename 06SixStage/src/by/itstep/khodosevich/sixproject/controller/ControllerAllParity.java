...
public class ControllerAllParity {
    public static void main(String[] args) {
        ...
        String msg = String.format("Among your nubmers %d, %d, %d - are there all parity? "+
                "\nAnswer: %b.", var1, var2, var3, checkAllParityNumber(var1, var2, var3));
